        ...
        {safeIncidents.length === 0 ? (
          ...
          safeIncidents.map((incident) => (
            <div key={incident.id} className="bg-gray-900 rounded-lg p-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-gray-400 text-xs">
                      {incident.type?.replace('_', ' ').toUpperCase() || 'UNKNOWN'}
                    </span>
                  </div>
                  <p className="text-white text-sm font-medium">{incident.description || 'No description'}</p>
              ...
              {incident.responseActions && incident.responseActions.length > 0 && (
